                ...
                <section className="relative w-full py-20 px-6 lg:px-16 overflow-hidden">
                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1 relative min-h-[400px] rounded-xl overflow-hidden border border-[#f20d0d]/20 bg-[#0f0808] group">
                            ...
                            {/* Pulse Dots */}
                            <div className="absolute top-1/2 left-1/4 w-3 h-3 bg-[#f20d0d] rounded-full animate-ping"></div>
                            <div className="absolute top-1/2 left-1/4 w-3 h-3 bg-[#f20d0d] rounded-full"></div>
                            <div className="absolute top-2/3 right-1/3 w-2 h-2 bg-[#f20d0d] rounded-full animate-ping"></div>
                            <div className="absolute top-2/3 right-1/3 w-2 h-2 bg-[#f20d0d] rounded-full"></div>
                            <div className="absolute bottom-1/3 left-1/3 w-4 h-4 bg-[#f20d0d]/50 rounded-full animate-pulse"></div>
                        </div>
                    </div>
                </section>
